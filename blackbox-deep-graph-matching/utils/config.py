...
__C.Geek = edict()
__C.Geek.KPT_ANNO_DIR = "./data/Geek_kan_v1/annotations/character/keypoints"
__C.Geek.ROOT_DIR = "./data/Geek_kan_v1/"
__C.Geek.SET_SPLIT = "./data/Geek_kan_v1/split/geek_pairs.npz"
